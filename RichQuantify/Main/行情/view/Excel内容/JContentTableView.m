...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        ContentCollectionView *contentCollectionView = [[ContentCollectionView alloc] initWithFrame:CGRectMake(60, 0, self.frame.size.width-60, 60) collectionViewLayout:collectionViewFlowLayout];
    ...
    cell.contentCollectionView.cellID = numArr[indexPath.row];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if(self.indexBlock)
    {
        self.indexBlock(numArr[indexPath.row]);
    }
}
...
{
    ContentCollectionView *collView = (ContentCollectionView *)collectionView;
    if(self.indexBlock)
    {
        self.indexBlock(collView.cellID);
    }
}
